 ...
 * @author Alex
 */
public class QueryReservationByResNumberServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Reservation reservation = dbm.getReservation(Integer.parseInt(ReservationNumber));
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>Find Reservation by Reservation Number</h2>");
